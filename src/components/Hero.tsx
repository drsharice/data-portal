...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-brand-black text-white">
      ...
      {/* CONTENT — centered; extra top padding to clear fixed header */}
      <div className="relative z-10 min-h-screen grid place-items-center px-4 pt-20 md:pt-24">
        <div className="w-full">
          {/* WIDER + TALLER card to overlap ~half of the ring */}
          <div className="glass-card mx-auto w-[88vw] max-w-[90rem] min-h-[52vh] px-12 md:px-16 flex flex-col items-center justify-center text-center gap-4">
            <h1 className="text-5xl md:text-7xl xl:text-8xl font-extrabold tracking-tight">DATA PORTAL</h1>
            <p className="text-base md:text-lg text-white/85">
             Browse rich datasets, navigate with clear docs, tap into stable APIs, and get real-time support from our chatbot—your guide to everything data in our space.
            </p>
